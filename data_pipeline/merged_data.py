...
df_gas_prices = pd.read_parquet("data/processed/ttf_gas_prices.parquet")
...
df_merged = df_prices.join(df_calendar, how="left").join(df_loadst, how="left").join(df_temperature, how="left").join(df_wind_offshore, how="left").join(df_wind_onshore, how="left").join(df_gas_prices, how="left")
